	...
	<div class="large-12 columns">
		...
		<div class="row">
			<div class="large-6 columns">
				<a class="pics" href="<?php echo get_template_directory_uri() . '/images/capslocknotification.png'; ?>" data-lightbox="capslock" >
					<img
			...
			<div class="large-12 columns">
				...
				<div class="row ">
					...
					<div class="large-4 small-6 columns">						
						...
						<h6 class="panel"><b>System Tray</b><br>It stays out of your way! There is no need for it to be your standard list of desktop applications so CapsLock Notification adds itself as a simple tray icon, letting you know it's running.</h6>
					</div>
